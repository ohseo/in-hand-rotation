...
public class AxisLogManager : MonoBehaviour
{

    [SerializeField]
    private RotationInteractor _rotationInteractor;
    [SerializeField]
    private AxisSceneManager _axisSceneManager;
    ...
    {
        _axisSceneManager.GetDieTransform(out _dieWorldPosition, out _dieWorldRotation);
        _rotationInteractor.GetDieLocalTransform(out _dieLocalPosition, out _dieLocalRotation);
        _axisSceneManager.GetTargetOffset(out _targetOffsetPosition, out _targetOffsetRotation);
    }

    public void UpdateHeadData()
    {
        _axisSceneManager.GetHeadTransform(out _headWorldPosition, out _headWorldRotation);
    }
